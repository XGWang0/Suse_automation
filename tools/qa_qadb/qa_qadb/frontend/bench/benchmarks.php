...
<head>
    ...
    <link href="qadb_ico_1.png" rel="icon" type="image/png">
</head>
<body>
<a name="nav"></a>
...
# 7. clear old images from the image directory
$imgdir_rel = '/output';
...
{
	global $from, $lev_attrs, $separator, $group_by, $cookie_val;
