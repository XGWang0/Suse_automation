...
ALTER TABLE `machine` ADD COLUMN memsize VARCHAR(255) NOT NULL DEFAULT '' AFTER `cpu_vendor_id`;
ALTER TABLE `machine` ADD INDEX(memsize);

ALTER TABLE `machine` ADD COLUMN disksize VARCHAR(255) NOT NULL DEFAULT '' AFTER `memsize`;
