...
?>
    ...
    <td><input type="text" size="20" name="jobname" title="required: job name, must be composed by number, letter, underscroe or dash" value="<?php echo $jobInfo['name']; ?>"><span class="required">*</span>
    </td></tr>
