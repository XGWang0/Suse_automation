...
<input type="text" name="repourl" id="repourl" size="66" value="<?php if(isset($_POST["repourl"])){echo $_POST["repourl"];} ?>" title="required: url"/><span class="required">*</span><span class="text-main"></span>
  ...
  <br />
  <br />
  <label for="label" class="text-main">Assign Hostname to Loopback IP?</label>
  <label class="text-main"><input type="checkbox" name="loopback" id="loopback"/>Yes!</label>
  <br />
  <br />
  <span class="text-main"><B>BE NOTICED:</B> temporary pxe files generated by this function will be deleted in 20 minutes automatically. So you may re-run this function after they expired. </span><br /><br />
