...
def create_systemwide_configuration(backup_dir=None):
    ''' Create system-wide configuration replacing the existing files with the files
    automatically generated from templates. 
    
    Keyword arguments:
    backup_dir -- if this argument is set, the original versions of the files will be
                  backed up into that directory and can later be restored with 
                  restore_systemwide_configuration
    '''
    
    # TODO: implement
    # mktemp
    # create controller templates into temp dir
    # if backup_dir
    #  if exist & has content: exception
    #  create it if not exist
    #  copy every file generated by controller templates to it if it exists
    #  add every file/directory generated by controller templates that does not exist to backup_dir/!DELME
    # copy every file generated by controller templates to the system location
    # delete temp dir 
    pass


def restore_systemwide_configuration(backup_dir):
    ''' Restore system-wide configuration stored by create_systemwide_configuration 
    and deletes backup_dir
    
    Keyword arguments:
    backup_dir -- path to directory where the backup is located
    '''
    
    # TODO: implement
    # if not backup_dir: exception
    # if exist backup_dir/!DELME:
    #  delete paths specified in that file
    #  delete backup_dir/!DELME
    # copy content from backup_dir/ to /
    # delete backup_dir
    pass
