...
Requires:       nbd
Requires:       qa_test_virtualization
...
%package jdashboard
Summary: qa package for virtualization automation dashboard
Group: SUSE internal package

%description jdashboard
QA jenkins dashboard for virutlaiztion automation
...
#Install jdashboard
install -m 755 -d %{buildroot}%{_datadir}/qa/virtauto_dashboard
cp -a jenkins/jenkins_dashboard/* %{buildroot}%{_datadir}/qa/virtauto_dashboard
find %{buildroot}%{_datadir}/qa/virtautolib -depth -type d -name .pyc -exec rm -rf {} \;
...
%exclude %{_datadir}/qa/virtauto_dashboard
%{_datadir}/qa
%doc COPYING

%files jdashboard
%defattr(-, root, root)
%{_datadir}/qa/virtauto_dashboard
