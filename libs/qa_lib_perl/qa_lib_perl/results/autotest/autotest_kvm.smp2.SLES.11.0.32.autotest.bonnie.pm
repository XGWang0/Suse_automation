...
package results::autotest::autotest_kvm_smp2_SLES_11_0_32_autotest_bonnie;
...
{	
	...
	open $self->{FILE_HANDLE}, $self->path()."/$testsuite_name/guest_autotest_results/bonnie/debug/bonnie.DEBUG" or die("Cannot open file $testsuite_name/guest_autotest_results/bonnie/debug/bonnie.DEBUG :$!");
